...
const eventLabel = (label, sub, arrow = false) => (
  <div className="flex flex-col items-center gap-1 text-center">
    ...
    {arrow && (
      <svg viewBox="0 0 32 16" className="mt-1 w-8 opacity-60" fill="none" aria-hidden="true">
        <path d="M2 8 C8 4 16 4 24 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M20 5 L24 8 L20 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )}
  </div>
)
...
const customerDays = [
  { day: 'Sunday',    bg: '#bdd5e2', dark: false, content: eventLabel('Ordering Opens', '12:00 PM', true) },
  { day: 'Monday',    bg: '#7a9e6e', dark: true,  content: img('/cabbage.png') },
  { day: 'Tuesday',   bg: '#d4b896', dark: false, content: eventLabel('Ordering Closes', '2pm') },
  { day: 'Wednesday', bg: '#c8513b', dark: true,  content: img('/pea.png') },
  { day: 'Thursday',  bg: '#d4b896', dark: false, content: eventLabel('Delivery Day!', '12:00 PM – 5:00 PM') },
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-6 py-12">
      ...
      <div className="mb-3 flex items-end gap-4">
        <h2 className="text-4xl font-bold tracking-tight">Customer Information</h2>
