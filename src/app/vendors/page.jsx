...
const vendorDays = [
  ...
  { day: 'Tuesday',   bg: '#d4b896', dark: false, content: eventLabel('Receive Picklist', '2pm') },
  { day: 'Wednesday', bg: '#c8513b', dark: true,  content: eventLabel('Harvest / Prepare') },
  { day: 'Thursday',  bg: '#d4b896', dark: false, content: eventLabel('Drop off to CFC') },
  { day: 'Friday',    bg: '#a8c4a0', dark: false, content: img('/beet.png') },
  { day: 'Saturday',  bg: '#802048', dark: true,  content: eventLabel('Finalize Inventory') },
]
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-6 py-12">
      ...
      <div className="mb-3 flex items-end gap-4">
        <h2 className="text-4xl font-bold tracking-tight">Vendor Information</h2>
      ...
      <a href="mailto:info@countyfarmcollective.com?subject=Vendor%20Inquiry%20-%20County%20Farm%20Collective" className="mb-8 inline-flex rounded-full bg-brand-primary px-5 py-2.5 text-sm font-semibold text-[#f7f4ed] hover:bg-brand-primary-dark">Email to get started</a>

      <div className="mb-8">
        <Link href="/code-of-conduct" className="rounded-2xl border border-[#e2d8ca] bg-[#fffdf8] p-6 transition hover:border-brand-sage hover:bg-[#f8f4ec] inline-block w-full md:w-auto">
